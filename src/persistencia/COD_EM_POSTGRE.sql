...
CREATE TABLE IF NOT EXISTS AMOSTRA (
  ...
  FOREIGN KEY (ID_REPONSAVEL) REFERENCES RESPONSAVEL (ID_REPONSAVEL)ON DELETE CASCADE
);
...
CREATE TABLE AMOSTRA_ANALISES(
  ...
  FOREIGN KEY(ID_AMOSTRAR) REFERENCES AMOSTRA (ID_AMOSTRA)ON DELETE CASCADE,
